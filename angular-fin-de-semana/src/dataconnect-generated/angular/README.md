...
## ListMyEvents
You can execute the `ListMyEvents` Query using the following Query injector, which is defined in [dataconnect-generated/angular/index.d.ts](./index.d.ts):

```javascript
injectListMyEvents(options?: ListMyEventsOptions, injector?: Injector): CreateDataConnectQueryResult<ListMyEventsData, undefined>;
```

### Variables
The `ListMyEvents` Query has no variables.
### Return Type
Recall that calling the `ListMyEvents` Query injector returns a `CreateDataConnectQueryResult` object. This object holds the state of your Query, including whether the Query is loading, has completed, or has succeeded/failed, and any data returned by the Query, among other things.
...
To access the data returned by a Query, use the `CreateDataConnectQueryResult.data()` function. The data for the `ListMyEvents` Query is of type `ListMyEventsData`, which is defined in [dataconnect-generated/index.d.ts](../index.d.ts). It has the following fields:
```javascript
...
### Using `ListMyEvents`'s Query injector

```javascript
... // other imports
import { connectorConfig } from '@dataconnect/generated';
import { injectListMyEvents, ListMyEventsOptions } from '@dataconnect/generated/angular'
...
export class MyComponent {
  ...
  query = injectListMyEvents();

  // You can also pass in an options function (not object) of type `ListMyEventsOptions` to the Query injector function.
  options: ListMyEventsOptions = () => {
    return {
      staleTime: 5 * 1000
    };
  };
  query = injectListMyEvents(this.options);
}
```
...
## CreateEvent
You can execute the `CreateEvent` Mutation using the `CreateDataConnectMutationResult` object returned by the following Mutation injector (which is defined in [dataconnect-generated/angular/index.d.ts](./index.d.ts)):
```javascript
injectCreateEvent(options?: CreateEventOptions, injector?: Injector): CreateDataConnectMutationResult<CreateEventData, CreateEventVariables, CreateEventVariables>;
```
...
```
### Return Type
Recall that calling the `CreateEvent` Mutation injector returns a `CreateDataConnectMutationResult` object. This object holds the state of your Mutation, including whether the Mutation is loading, has completed, or has succeeded/failed, among other things.
...
To access the data returned by a Mutation, use the `CreateDataConnectMutationResult.data()` function. The data for the `CreateEvent` Mutation is of type `CreateEventData`, which is defined in [dataconnect-generated/index.d.ts](../index.d.ts). It has the following fields:
```javascript
...
### Using `CreateEvent`'s Mutation injector

```javascript
... // other imports
import { connectorConfig, CreateEventVariables } from '@dataconnect/generated';
import { injectCreateEvent, CreateEventOptions } from '@dataconnect/generated/angular'
import { DataConnect } from '@angular/fire/data-connect';
import { initializeApp } from '@angular/fire/app';
...
export class MyComponent {
  ...
  mutation = injectCreateEvent();

  // You can also pass in a `CreateEventOptions` function (not object) to the Mutation injector function.
  options: CreateEventOptions = () => {
    return {
      onSuccess: () => { console.log('Mutation succeeded!'); }
    };
  };
  mutation = injectCreateEvent(this.options);
  ...
  executeMutation() {
    ...
    this.mutation.mutate(createEventVars);
    // Variables can be defined inline as well.
    this.mutation.mutate({ title: ..., eventDate: ..., description: ..., location: ..., });
    ...
    this.mutation.mutateAsync(createEventVars);

    // You can also pass in a `CreateEventOptions` object (not function) to `CreateDataConnectMutationResult.mutate()`.
    this.mutation.mutate(createEventVars, this.options());
  }
}
```

## JoinEvent
You can execute the `JoinEvent` Mutation using the `CreateDataConnectMutationResult` object returned by the following Mutation injector (which is defined in [dataconnect-generated/angular/index.d.ts](./index.d.ts)):
```javascript
injectJoinEvent(options?: JoinEventOptions, injector?: Injector): CreateDataConnectMutationResult<JoinEventData, JoinEventVariables, JoinEventVariables>;
```
...
```
### Return Type
Recall that calling the `JoinEvent` Mutation injector returns a `CreateDataConnectMutationResult` object. This object holds the state of your Mutation, including whether the Mutation is loading, has completed, or has succeeded/failed, among other things.

To check the status of a Mutation, use the `CreateDataConnectMutationResult.status()` function. You can also check for pending / success / error status using the `CreateDataConnectMutationResult.isPending()`, `CreateDataConnectMutationResult.isSuccess()`, and `CreateDataConnectMutationResult.isError()` functions.

To execute the Mutation, call `CreateDataConnectMutationResult.mutate()`. This function executes the Mutation, but does not return the data from the Mutation. 

To access the data returned by a Mutation, use the `CreateDataConnectMutationResult.data()` function. The data for the `JoinEvent` Mutation is of type `JoinEventData`, which is defined in [dataconnect-generated/index.d.ts](../index.d.ts). It has the following fields:
```javascript
...
### Using `JoinEvent`'s Mutation injector

```javascript
... // other imports
import { connectorConfig, JoinEventVariables } from '@dataconnect/generated';
import { injectJoinEvent, JoinEventOptions } from '@dataconnect/generated/angular'
import { DataConnect } from '@angular/fire/data-connect';
import { initializeApp } from '@angular/fire/app';
...
export class MyComponent {
  // Call the Mutation injector function to get a `CreateDataConnectMutationResult` object which holds the state of your Mutation.
  mutation = injectJoinEvent();

  // You can also pass in a `JoinEventOptions` function (not object) to the Mutation injector function.
  options: JoinEventOptions = () => {
    return {
      onSuccess: () => { console.log('Mutation succeeded!'); }
    };
  };
  mutation = injectJoinEvent(this.options);
  ...
  executeMutation() {
    ...
    this.mutation.mutate(joinEventVars);
    // Variables can be defined inline as well.
    this.mutation.mutate({ eventId: ..., });

    // You can call `CreateDataConnectMutationResult.mutateAsync()` to execute the Mutation and return a promise with the data returned from the Mutation.
    this.mutation.mutateAsync(joinEventVars);

    // You can also pass in a `JoinEventOptions` object (not function) to `CreateDataConnectMutationResult.mutate()`.
    this.mutation.mutate(joinEventVars, this.options());
  }
}
```

## VoteOnPollOption
You can execute the `VoteOnPollOption` Mutation using the `CreateDataConnectMutationResult` object returned by the following Mutation injector (which is defined in [dataconnect-generated/angular/index.d.ts](./index.d.ts)):
```javascript
injectVoteOnPollOption(options?: VoteOnPollOptionOptions, injector?: Injector): CreateDataConnectMutationResult<VoteOnPollOptionData, VoteOnPollOptionVariables, VoteOnPollOptionVariables>;
```
...
```
### Return Type
Recall that calling the `VoteOnPollOption` Mutation injector returns a `CreateDataConnectMutationResult` object. This object holds the state of your Mutation, including whether the Mutation is loading, has completed, or has succeeded/failed, among other things.

To check the status of a Mutation, use the `CreateDataConnectMutationResult.status()` function. You can also check for pending / success / error status using the `CreateDataConnectMutationResult.isPending()`, `CreateDataConnectMutationResult.isSuccess()`, and `CreateDataConnectMutationResult.isError()` functions.

To execute the Mutation, call `CreateDataConnectMutationResult.mutate()`. This function executes the Mutation, but does not return the data from the Mutation. 

To access the data returned by a Mutation, use the `CreateDataConnectMutationResult.data()` function. The data for the `VoteOnPollOption` Mutation is of type `VoteOnPollOptionData`, which is defined in [dataconnect-generated/index.d.ts](../index.d.ts). It has the following fields:
```javascript
...
### Using `VoteOnPollOption`'s Mutation injector

```javascript
... // other imports
import { connectorConfig, VoteOnPollOptionVariables } from '@dataconnect/generated';
import { injectVoteOnPollOption, VoteOnPollOptionOptions } from '@dataconnect/generated/angular'
import { DataConnect } from '@angular/fire/data-connect';
import { initializeApp } from '@angular/fire/app';
...
export class MyComponent {
  // Call the Mutation injector function to get a `CreateDataConnectMutationResult` object which holds the state of your Mutation.
  mutation = injectVoteOnPollOption();

  // You can also pass in a `VoteOnPollOptionOptions` function (not object) to the Mutation injector function.
  options: VoteOnPollOptionOptions = () => {
    return {
      onSuccess: () => { console.log('Mutation succeeded!'); }
    };
  };
  mutation = injectVoteOnPollOption(this.options);
  ...
  executeMutation() {
    ...
    this.mutation.mutate(voteOnPollOptionVars);
    // Variables can be defined inline as well.
    this.mutation.mutate({ pollOptionId: ..., });

    // You can call `CreateDataConnectMutationResult.mutateAsync()` to execute the Mutation and return a promise with the data returned from the Mutation.
    this.mutation.mutateAsync(voteOnPollOptionVars);

    // You can also pass in a `VoteOnPollOptionOptions` object (not function) to `CreateDataConnectMutationResult.mutate()`.
    this.mutation.mutate(voteOnPollOptionVars, this.options());
  }
}
```
